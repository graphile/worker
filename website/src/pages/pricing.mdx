...
PostGraphile V4 Core is free and open-source, and is sufficient for many peoples
needs. PostGraphile Pro is a commercial plugin for PostGraphile V4 Core, with
additional features which can help your team to save development costs before
